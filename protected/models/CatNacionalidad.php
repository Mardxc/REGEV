...
/**
 * This is the model class for table "cat_nacionalidad".
 *
 * The followings are the available columns in table 'cat_nacionalidad':
 ...
 */
class CatNacionalidad extends CActiveRecord
{
	/**
	...
	public function relations()
	{
		...
		return array(
			'solSolicitantes' => array(self::HAS_MANY, 'SolSolicitante', 'id_nacionalidad'),
		);
	}
	 ...
	 * @return CatNacionalidad the static model class
	 */
